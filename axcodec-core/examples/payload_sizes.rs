use axcodec_core::{Encode, buffer::VecWriter};
use axcodec_derive::{Decode as DecodeDerive, Encode as EncodeDerive, View as ViewDerive};
...
fn main() {
    println!("╔═══════════════════════════════════════════════════════════════╗");
    println!("║       AxCodec Payload Size Reference (bytes)                  ║");
    println!("╚═══════════════════════════════════════════════════════════════╝");
    println!();
    ...
    println!("Summary: AxCodec overhead is fixed per struct (~17 bytes for Packet).");
